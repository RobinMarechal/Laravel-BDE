...
@section('content')
	...
	<hr>
		...
		<a class="see-all" href="{{ url('events/coming') }}"><span class="glyphicon glyphicon glyphicon-arrow-left"></span> Voir les événements <u>à venir</u></a><br>
	@if(isset($all))
		<a class="see-all" href="{{ url('events/past') }}"><span class="glyphicon glyphicon glyphicon-arrow-left"></span> Ne voir que les événements <u>passés</u> qui ne <u>concernent aucune team</u></a>
	@else
		<a class="see-all" href="{{ url('events/past/all') }}"><span class="glyphicon glyphicon glyphicon-arrow-left"></span> Voir <u>tous</u> événements <u>passés</u></a>
	@endif
